...
>(
  (
    ...
    const tooltipLabel = React.useMemo(() => {
      ...
      if (labelFormatter) {
        return (
          <div className={cn("font-medium ext-zinc-100", labelClassName)}>
  ...
  (
    ...
    return (
      <div
        ref={ref}
        className={cn(
          "flex items-center justify-center gap-4 text-mute",
          ...
          return (
            ...
            >
              {itemConfig?.icon && !hideIcon ? (
                ...
                <div
                  className="h-2 w-2 shrink-0 rounded-[2px] text-zinc-300"
                  style={{
