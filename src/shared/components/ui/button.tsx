  ...
  "inline-flex items-center justify-center rounded-md text-sm font-medium ring-offset-background transition-colors disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-input bg-primary/80 hover:bg-bg-primary/90 hover:text-accent-foreground",
        outlineSecondary:
        "border border-input bg-secondary/50 hover:bg-muted hover:text-accent-foreground",
        secondary:
